...
String msql="select * from criminalmaster,dept where criminalmaster.deptcode=dept.deptcode and city=?";
...
while(rs.next())
	...
	if(!dept.equals(dc))
		{
		out.println("<tr><td  colspan=4 class=pageheading >"+dc+"<hr></td></tr>");
		dept=dc;
		i=0;
		}
%>
